...
The details below are family-supplied starting claims. They have not yet been
confirmed against records.

### Cruz Reyes Vasquez

- Relationship to researcher: grandmother.
- Supplied name: Cruz (m. Reyes) Vasquez.
...
- Spouse: Raphael/Rafael Vasquez or Vázquez.
- Supplied father: Mauricio Reyes.
- Supplied paternal-grandmother clue: Mauricio's mother had the surname
  Martínez.
- Supplied mother: Carmen Reyes, with “Belén” supplied as a maiden-name or
  family-name clue; the exact name structure is unresolved.

### Raphael or Rafael Vasquez

- Relationship to researcher: grandfather.
- Supplied name: Raphael Vasquez; family reports the original spelling was
  Vázquez.
- Name variants to search: Raphael Vasquez, Rafael Vasquez, Raphael Vázquez,
  Rafael Vázquez.
- Supplied birth: 24 October 1906, Puerto Rico.
- Supplied death: 30 December 1984, date uncertain, place not yet supplied.
- Supplied burial: Rosedale & Rosehill Cemetery in Linden, New Jersey
  (family called it “Rosehill”).
...
- Family account supplied in conversation on 23 July 2026.
- Family documents:
- Photographs:
...
1. Obtain the original cemetery interment cards and NYC death certificates for
   Cruz and Rafael.
2. Determine whether the couple ever resided in New Jersey or were transported
   there from New York solely for burial.
...
- The 1950 census places Rafael and Cruz together on East 109th Street in
  Manhattan. Details of potentially living descendants are intentionally not
  tracked here.
- The official cemetery lookup places both people in plot `WIN4T-22-11` at the
  combined Rosedale & Rosehill property. The database assigns the plot to the
  **Rosedale** division: Cruz was buried 13 October 1998 and Rafael 2 January
  1985.
